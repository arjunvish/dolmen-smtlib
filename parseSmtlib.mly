...
%token ASSERT CHECK_SAT CHECK_SAT_ASSUMING DECLARE_CONST DECLARE_DATATYPE DECLARE_DATATYPES
%token DECLARE_FUN DECLARE_SORT DEFINE_FUN DEFINE_FUN_REC DEFINE_FUNS_REC DEFINE_SORT
%token ECHO EXIT GET_ASSERTIONS GET_ASSIGNMENT GET_INFO GET_MODEL GET_OPTION GET_PROOF
%token GET_UNSAT_ASSUMPTIONS GET_UNSAT_CORE GET_VALUE POP PUSH RESET RESET_ASSERTIONS
%token SET_INFO SET_LOGIC SET_OPTION

%parameter <L : Location.S>
